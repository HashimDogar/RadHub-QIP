  ...
  if (!codeOk){
    return (
      <section className="card">
        ...
        <div className="actions"><button className="primary" disabled={unlockBusy} onClick={unlock} style= {{ marginTop: 15}}>{unlockBusy?'Unlocking…':'Unlock'}</button></div>
  ...
  return (
    <div className="grid">
      ...
      <section className="card">
        ...
        <div style={{ marginTop: 12 }}>
          <label>Clinical Indication: Please rate how appropriate the indication was for this request.</label>
